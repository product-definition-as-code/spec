...
| Conformance tests (complete, normative set) | In progress; the 45 published cases run today via [pdac-conformance](https://www.npmjs.com/package/pdac-conformance) |
