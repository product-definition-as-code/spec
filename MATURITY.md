...
| Conformance | 43 published cases runnable, covering initialisation, the citation contract, configuration, topology, artifact kinds, most of the Product Change band, the full Structured Behaviour matrix and JSON Pointer diagnostic fields, run by [`pdac-conformance@1.0.0`](https://www.npmjs.com/package/pdac-conformance). This is executable suite capability, not ProductShape pass evidence: ProductShape has not implemented RFC 0084 (see [conformance/README.md](conformance/README.md)). |
