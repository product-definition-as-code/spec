...
A Bounded Context is a product-language boundary: it delimits where a set of domain terms carries a specific meaning. Bounded contexts in v0.1 do not imply aggregates, implementation modules or source-code structure.
