...
**Status: in progress (scaffolded).** This directory holds the portable conformance corpus: a set of
fixture repositories plus expected-diagnostics files that any implementation, in any language, can
run to verify conformance with the specification.
