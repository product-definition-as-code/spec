# forecast-modified-apply-dry-run

Prospective report is computed from effective diff; real apply and dry run have identical records; consumer bytes stay unchanged.
