...
Resolved during elaboration: the report names the unknown target, and one diagnostic per unresolved reference is the granularity that keeps reports deterministic.
